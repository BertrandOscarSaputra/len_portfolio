...
export default function WorksCarousel({ works }: WorksCarouselProps) {
  ...
  return (
    <div className="relative w-full">
      ...
      <button
        onClick={goToNext}
        className="absolute right-0 sm:right-2 top-1/2 cursor-pointer -translate-y-1/2 z-20 w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-zinc-900 border-2 border-zinc-700 flex items-center justify-center text-white hover:bg-zinc-800 hover:border-blue-500/50 transition-all duration-300 hover:scale-110 shadow-lg"
